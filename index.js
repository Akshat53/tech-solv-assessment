...
function crossStringClick(elem) {
  var target = elem;
...
document.addEventListener("DOMContentLoaded", function () {
  var customDropDwon = document.querySelectorAll(".custmonDropDwon");

  customDropDwon.forEach(function (dropdown) {
  ...
  // filterToggelBtn
  document.querySelectorAll(".filterToggelBtn").forEach((btn) => {
    btn.addEventListener("click", function () {
      document.querySelector(".filterToggel").classList.toggle("active");
    });
  });
  document.querySelectorAll(".hideCustomDrp").forEach((elem) => {
    elem.addEventListener("click", function () {
      document.querySelectorAll(".customDrp").forEach((drp) => {
  ...
  document.addEventListener("click", function (e) {
    ...
    if (
      ...
      var customPopup = document.querySelector('.class="customPopup active');
      if (customPopup) {
  ...
  document.querySelectorAll(".closeIcon").forEach((icon) => {
    icon.addEventListener("click", function () {
      ...
      document.querySelectorAll(".commonPopup").forEach((popup) => {
        popup.classList.remove("active");
      });
  ...
  window.addEventListener("scroll", function () {
    ...
    var gototopIconDiv = document.querySelector(".gototopIconDiv");

    if (scolled > 200) {
      gototopIconDiv.style.display = "block";
      gototopIconDiv.style.opacity = "1";
    } else {
      gototopIconDiv.style.display = "none";
      gototopIconDiv.style.opacity = "0";
    }
  });
  document
  ...
  // });
  document
    .querySelectorAll(".header-for-mobile .searchPopup")
    .forEach((elem) => {
      elem.addEventListener("click", function () {
...
let toggleCurrencyMoreDataState = null;
...
function toggleCurrencyMoreData(elem) {
  ...
  const currentstate = elem.innerText;
  const alternate = elem.dataset.alternate;

  const currencyDetail = document.querySelector(".currencyDetail");
  const bottomListing = currencyDetail.querySelector(".bottomListing");

  if (currentstate === alternate) {
    bottomListing.style.display = "none";
    elem.innerHTML = toggleCurrencyMoreDataState;
  } else {
    bottomListing.style.display = "block";
    elem.innerHTML = alternate;
  }
}
